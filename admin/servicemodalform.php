...
if(isset($_POST['dnkid'])){
    ...
    $query=mysqli_query($conn,"select * from service where id='".$_POST['dnkid']."'");
...
if(isset($_POST['submitt']))
{
    ...
    $sql="UPDATE service SET title='$titlee',description='$descriptionn',status='$statuss',icon='$filee' where id='$id'";
    if (mysqli_query($conn, $sql)){
      echo "<script> alert ('New record has been added successfully !');window.location='service.php';</script>";
