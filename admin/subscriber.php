...
if(isset($_GET['delid'])){
  ...
  $dnk=mysqli_query($conn,"delete from subscriber where id='$id'");
  if($dnk=1){
                        ...
                        ?>
                                             <tr>
                                                ...
                                                if($status=='1'){
                                                    ...
                                                    echo '<span class="badge badge-secondary">Unverified</span>';
                                                }
                                                ?>    
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="subscriber.php?delid=<?php echo $arr['id']; ?>"><button
