...
<html lang="en">
    ...
    <body>
        ...
        <!--====== End Hero Section ======-->
        <!--====== Start Intro Section ======-->
        <section class="intro-area pt-115">
            <div class="container">
                ...
                <div class="intro-wrppaer-two bg_cover" style="background-image: url(assets/images/bg/video-bg-2.jpg);">
                    <div class="intro-content-box-one">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="work-process-wrapper">
                            <div class="row single-process-step align-items-center">
                                <div class="col-lg-6">
