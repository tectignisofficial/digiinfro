                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form_group">
                                            ...
                                            <span id="spanauthorized"></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form_group">
                                            <input type="tel" class="form_control" placeholder="WhatsApp No" minlength="10" maxlength="10" name="whatsapp_no" id="whatsapp_no">
                                            <span id="spanwhatsapp"></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form_group">
