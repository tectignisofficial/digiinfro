                                    ...
                                    <div class="tab-pane fade show active" id="overview" role="tabpanel"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 grid-margin">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h4 class="card-title">ANUH PHARMA LTD</h4>
                                                        <form class="form-sample">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        <label
                                                                            class="col-sm-3 col-form-label">Sex</label>
                                                                        <div class="col-sm-3">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label">CERTI.No
                                                                        </label>
                                                                        <div class="col-sm-9">
                                                                            <input type="text" class="form-control" />
                                                                        </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-3 col-form-label">Emp Code
                                                                        </label>
                                                                        <div class="col-sm-9">
                                                                            <input type="number" class="form-control" />
                                                                        </div>
                    ...
                    <form class="form-sample">
                      ...
                      <div class="col-md-6">
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">R.B.C Count </label>
                                    <div class="col-sm-9">
                                      <input type="text" class="form-control" />
                                    </div>
                                  </div>
                                ...
                                <div class="col-md-6">
                                  <div class="form-group row">
                                    <label class="col-sm-3 col-form-label">Platelate Count </label>
                                    <div class="col-sm-9">
                                      <input type="text" class="form-control" />
                                    </div>
                                  </div>
